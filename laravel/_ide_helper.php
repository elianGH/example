 ...
 * Generated for Laravel 7.17.2 on 2020-06-26 09:59:14.
 *
...
namespace Illuminate\Support\Facades {
    ...
    class Auth {
         ...
         *
         * @return \App\Models\Manager\User\Team|null
         * @static
         */
         ...
         *
         * @param mixed $id
         * @return \App\Models\Manager\User\Team|false
         * @static
         */
         ...
         *
         * @return \App\Models\Manager\User\Team
         * @static
         */
    ...
    class Log {
         ...
         * Interesting events.
         *
         * Example: Client logs in, SQL logs.
         *
         * @param string $message
         * @param array $context
         * @return void
...
namespace App\Services\Storage\Facades {
    ...
    class Storage {
         ...
         *
         * @param string $name
         * @return \App\Services\Storage\StorageService
         * @static
         */
        public static function disk($name)
        {
                        /** @var \App\Services\Storage\StorageService $instance */
         ...
         *
         * @param string $path
         * @param \Illuminate\Http\File|\App\Services\Storage\UploadedFile $file
         * @return \App\Services\Storage\StorageService
         * @static
         */
        ...
        {
                        /** @var \App\Services\Storage\StorageService $instance */
                        return $instance->putFile($path, $file);
        }
         ...
         * @static
         */
        public static function store($user = null, $public = false)
        {
                        /** @var \App\Services\Storage\StorageService $instance */
                        return $instance->store($user, $public);
        }
...
namespace App\ViewStructures\Facades {
    ...
    class Table {
         ...
         * @static
         */
        public static function fetch($model, $callback)
        {
                        /** @var \App\ViewStructures\TableView $instance */
                        return $instance->fetch($model, $callback);
        }
...
namespace  {
    ...
    class Storage extends \App\Services\Storage\Facades\Storage {}

    class Table extends \App\ViewStructures\Facades\Table {}
